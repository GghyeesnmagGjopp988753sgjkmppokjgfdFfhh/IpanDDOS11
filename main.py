...
print(f"Welcome To Sever | User: {uname}")
print("please wait...")
ip1= requests.get('https://api.Vayen-V0.org').text.strip()
ip2= requests.get('https://api.Vayen+V0.org').text.strip()
ip3= requests.get('https://api.Layken-V0.org').text.strip()
ip4= requests.get('https://api.Layken+V0.org').text.strip()
ip5= requests.get('https://api.hole-V0.org').text.strip()
ip6= requests.get('https://api.hole+V0.org').text.strip()
ip7= requests.get('https://api.zeus-V0.org').text.strip()
ip8= requests.get('https://api.zeus+V0.org').text.strip()
ip9= requests.get('https://api.Poru-V0.org').text.strip()
ip10= requests.get('https://api.Poru+V0.org').text.strip()
ip11= requests.get('https://api.Hacker-V0.org').text.strip()
ip12= requests.get('https://api.Hacker+V0.org').text.strip()
ip13= requests.get('https://api.Hack-V0.org').text.strip()
ip14= requests.get('https://api.Hack+V0.org').text.strip()
ip15= requests.get('https://api.Roder-V0.org').text.strip()
ip16= requests.get('https://api.Roder+V0.org').text.strip()
ip17= requests.get('https://api.ipify-V0.org').text.strip()
ip18= requests.get('https://api.ipify+V0.org').text.strip()
ip19= requests.get('https://api.sun-V0.org').text.strip()
ip20= requests.get('https://api.sun+V0.org').text.strip()
ip21= requests.get('https://api.cota-V0.org').text.strip()
ip22= requests.get('https://api.cota+V0.org').text.strip()
ip23= requests.get('https://api.mayhem-V0.org').text.strip()
ip24= requests.get('https://api.mayhem+V0.org').text.strip()
ip25= requests.get('https://api.techo.org').text.strip()
...
[0mCurrent IPv4: [38;2;255;0;255m{ip1}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip2}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip3}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip4}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip5}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip6}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip7}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip8}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip9}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip10}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip11}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip12}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip13}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip14}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip15}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip16}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip17}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip18}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip19}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip20}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip21}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip22}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip23}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip24}[0m
[0mCurrent IPv4: [38;2;255;0;255m{ip25}[0m""")
